class UserCredentials:
    ...
    it_edit_email = '052125test1@test.com'  # Credentials used for Edit page testing by Iryna T
    ...
    updated_old_password = 'UpdOldPass'
    updated_new_email = 'updated_new@test.com'
    ...
    to_delete_fname = 'Saruman'  # Used by Hanna Elis, should be registered after deletion
