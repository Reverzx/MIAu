...
def test_successful_put_upd(read_schema):
    """
    Verifies that the response status code is 200 for a successful
    PUT request to the /contacts endpoint.
...
@pytest.mark.parametrize('element_id, value, message', EditData.mandatory_fields_errors)
